...
{
    public sealed class HintAnnouncementConfig
    {
        [Description("This is the text that will be displayed when announced.")]
        public string HintText { get; set; } = "The underground section of the facility has been detonated. Radiation has been detected, please evacuate immediately.";
        ...
        public float HintTime { get; set; } = -1f;
    }
}
